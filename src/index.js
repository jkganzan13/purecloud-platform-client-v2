(function(factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['./ApiClient', './api/AlertingApi', './api/AnalyticsApi', './api/ArchitectApi', './api/AttributesApi', './api/AuthorizationApi', './api/BillingApi', './api/ContentManagementApi', './api/ConversationsApi', './api/ExternalContactsApi', './api/FaxApi', './api/GeolocationApi', './api/GreetingsApi', './api/GroupsApi', './api/IdentityProviderApi', './api/IntegrationsApi', './api/LanguagesApi', './api/LicenseApi', './api/LocationsApi', './api/MobileDevicesApi', './api/NotificationsApi', './api/OAuthApi', './api/OrganizationApi', './api/OrganizationAuthorizationApi', './api/OutboundApi', './api/PresenceApi', './api/QualityApi', './api/RecordingApi', './api/ResponseManagementApi', './api/RoutingApi', './api/ScriptsApi', './api/SearchApi', './api/StationsApi', './api/SuggestApi', './api/TelephonyProvidersEdgeApi', './api/TokensApi', './api/UserRecordingsApi', './api/UsersApi', './api/UtilitiesApi', './api/VoicemailApi', './api/WebChatApi', './api/WorkforceManagementApi'], factory);
